...
//         it('api.getBundle()', function () {
//             var fixture = libpath.join(fixturesPath, 'mojito-newsboxes'),
//                 locator = new BundleLocator(),
//                 bundle;
//             locator.parseBundle(fixture);
//             bundle = locator.getBundle('Shelf');
...
//         it('api.getRootBundle()', function () {
//             var fixture = libpath.join(fixturesPath, 'mojito-newsboxes'),
//                 locator = new BundleLocator(),
//                 rootBundleName;

//             locator.parseBundle(fixture);
//             rootBundleName = locator.getRootBundle();
...
//             have = locator.parseBundle(fixture, options);
...
//             locator.parseBundle(fixture, options);
