...
BundleLocator.prototype = {
     ...
     * @return {nothing}
     */
    plug: function(plugin, filter) {
        if (!filter && plugin.describe) {
            filter = {};
            if (plugin.describe.extensions) {
                filter.extensions = plugin.describe.extensions;
            }
            if (plugin.describe.types) {
                filter.extensions = plugin.describe.types;
            }
        }
        if (filter) {
            // sugar for users
