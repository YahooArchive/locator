...
var libpath = require('path'),
    ...
    Y = require('yui').YUI({useSync: true}).use('promise'),
...
function BundleLocator(options) {
    ...
    this._pluginAPI = {
        promise: function(fn) {
            return new Y.Promise(fn);
        }
        /* TODO:  compilers and file watching
        writeFile: function(bundleName, relativePath, contents, options) {
            return new Y.Promise(function(fulfill, reject) {
                var path = libpath.resolve(this._bundles[bundleName].baseDirectory, relativePath);
...
BundleLocator.prototype = {
     ...
     * @method plug
     * @param {string|array of strings} extensions The filesystem extensions (NOT including dot)
     * for which the plugin should be called.
    ...
    plug: function(extensions, plugin) {
        var self = this,
            filter = {};
        if (!extensions && plugin.describe) {
            extensions = plugin.describe.extensions;
        }
        ...
        self._plugins.push({
            // a lookup map to make runtime faster
            filter: filter,
            plugin: plugin
        });
    },
    ...
    _makeBundle: function(path, options) {
        ...
        return new Y.Promise(function(fulfill, reject) {
            ...
            // FUTURE:  also add {compiledPath}/{name} to _bundlePaths
    ...
    _onResource: function(res, what) {
        ...
        self._plugins.forEach(function(plugin) {
            if ((plugin.filter[ext] || plugin.filter[ALL_EXTENSIONS]) && plugin.plugin[what]) {
                // Wrap all plugins in promises, so that sync plugins won't
                // run before async ones.
                promises.push(new Y.Promise(function(fulfill, reject) {
 ...
 */
/**
 * @property {object} describe An object used to describe the plugin to humans
 * and to the locator.
 */
/**
 * @property {string} describe.summary Text summary for humans.
 */
/**
 * @property {string|[string]} [describe.extensions] A default list of
 * extensions for which the plugin should be used.
 ...
 * @optional
 * @param resourceAdded
 * @param {LocatorResource} The resource that was added or updated.
 * @param {LocatorPluginAPI} An "api" object that has utility methods.
 ...
 * @param {LocatorResource} The resource that was deleted.
 * @param {LocatorPluginAPI} An "api" object that has utility methods.
 * @return {Promise|undefined} Return a Promise/A
 * (http://wiki.commonjs.org/wiki/Promises/A) that the plugin will resolve once
 * it is done handling the resource. If the plugin returns undefined it
 ...
 */
/**
 * @property {string} bundleName The name of the bundle to which the resource belongs.
 */
/**
 * @property {string} bundlePath The filesystem path of the bundle to which the resource belongs.
 */
/**
 * @property {string} fullPath The full filesystem path to the resources.
 */
/**
 * @property {string} relativePath The filesystem path relative to the bundle.
 */
/**
 ...
 */
/**
 * @property {string} [subtype] The subtype of the resource, if it has one.
 */
/**
 * @property {string} selector The seletor for the resource.
 */
/**
 * @property {string} ext The filesystem extension of the resource.
 */
/**
 * @property {Stat} stat The filesystem statistics about the resource.
 */
 ...
 * @param {string} encoding The string encoding of the file.
 * @return {Promise} The new promise which will be fulfilled once the file is written (or rejected on failure).
 */
