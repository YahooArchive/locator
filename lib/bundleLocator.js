...
BundleLocator.prototype = {
    ...
    parseBundle: function (dir, options) {
        ...
        this._options.buildDirectoryNamer = options && options.buildDirectoryNamer;
     ...
     * a function
     * @param {Bundle} bundle @see ./bundle.js
     * @param {string} the bundle's base directory
     * @return {string}
     */
    _nameBuildDirectory: function (bundle, basedir) {
        var namerFn = this._options.buildDirectoryNamer,
            dirname;

        dirname = 'function' === typeof namerFn ?
            namerFn(bundle) : bundle.name + '-' + bundle.version;

        return libpath.resolve(basedir, dirname);
    },
