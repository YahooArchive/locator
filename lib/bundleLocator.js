...
BundleLocator.prototype = {
     ...
     */
    _makeBundle: function (path, options, parent) {
        var self = this;
        return new libpromise.Promise(function (fulfill, reject) {
            var pkg,
            ...
            bundle.name = name;
            bundle.version = (pkg && pkg.version) || (parent && parent.version) || DEFAULT_VERSION;
            bundle.type = ruleset;
    ...
    _processFileQueue: function () {
        ...
        return new libpromise.Promise(function (fulfill, reject) {
            ...
            if (ruleset._bundles) {
                ...
                if (options) {
                    return self._makeBundle(fullPath, options, bundle).then(function () {
                        fulfill();
                    }, reject);
                }
            }
     ...
     * about modown packages in the directory.  If the directory is not an NPM
    ...
    _walkPackage: function (pkg) {
        ...
        parentName = self._getBundleNameByPath(libpath.dirname(pkg.dir));
        parent = self._bundles[parentName];

        return this._makeBundle(pkg.dir, pkg.options, parent).then(function (bundle) {
