...
BundleLocator.prototype = {
                ...
                libdive(dir,
                    {
                        ...
                        directories: true,  // so we find sub-bundles as separate items
                        files: true,
                        recursive: true
                    },
     ...
     * @param {Function} filter optional function to execute on each bundle.
     ...
     * @return {Array} list of all bundles
     */
     ...
     */
    _walkPackages: function (dir, _depth) {
        var self = this;
        _depth = _depth || 0;
        return new libpromise.Promise(function (fulfill, reject) {
            var pkg,
                ...
                libfs.readdir(libpath.join(dir, 'node_modules'), function (readdirErr, subdirs) {
                    ...
                    subdirs.forEach(function (subdir) {
                        ...
                        subpkgsPromises.push(
                            self._walkPackages(libpath.join(dir, 'node_modules', subdir), _depth + 1)
                        );
                    });
     ...
     * This method works especially well with the output of _walkPackages().
     * @private
     * @method _resolvePackages
     * @param {array} all List of all the package metas to consider.
     * @return {array} The metas of the packages to actually use.
     */
    _resolvePackages: function (all) {
